...
<center>
<form class="vldform vldauth" method="post" action="bloginch.jsp"
		name="f" onSubmit='return call()'>
		<h1>Bank Log in</h1>
		<input class="vldform__textbox" type="text" placeholder="Bank Id"
			name="bid" required> <input class="vldform__textbox"
