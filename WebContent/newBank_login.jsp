...
<body translate="no">
<body>
<form class="vldform vldauth"  method="post" action="bloginch.jsp" name="f" onSubmit='return call()'>
<h1>Log in</h1>
<input class="vldform__textbox" type="text"  placeholder="Bank Id" name="bid" required>
<input class="vldform__textbox" type="password"  id="" placeholder="Password" name="pwd" required>

<tr> 

<SELECT class="vldform__textbox" NAME="bl">
<%
try
{
...
<a class="vldform__recoverypassword" href="#" onclick="window.location='newBank_signup.html'">Sign Up?</a>


<input class="vldform__button" type="submit" value="Log in" width="25%">
