		...
		<center>
			...
			<form class="design" method=post action="usercheck.jsp" name="f"
				onSubmit='return call()'>
				 ...
				 <input type="button" value="Account Info" onClick="window.location='viewacinfo.jsp'">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							
							<input type="button" value="Transfer Amount" onClick="window.location='traamt.jsp'">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							
							<input type="button" value="Transaction Report" onClick="window.location='treport.jsp'">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
